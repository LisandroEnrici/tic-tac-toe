...
The stable release of the app (v1.0) it's the application as it's found at the end of the tutorial mentioned above with a modularization process applied.
